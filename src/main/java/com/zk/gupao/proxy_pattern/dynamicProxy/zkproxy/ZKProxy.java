 ...
 * @description:模拟的动态代理，用来生成源代码
 * @author: zk
 * @create: 2019-03-23 15:33
 **/
public class ZKProxy {
    ...
    public static Object newProxyInstance(ZKClassLoader zkClassLoader, Class<?>[] interfaces, ZKMeipo zkMeipo) {
        try{
            ...
            Class proxyClass =  zkClassLoader.findClass("$Proxy0");
    ...
    private static String generateSrc(Class<?>[] interfaces) {
        ...
        sb.append("package com.zk.gupao.proxy_pattern.dynamicProxy.zkproxy;" + ln);
        sb.append("import com.zk.gupao.proxy_pattern.Person;" + ln);
